...
import controller.TelaServico_1_OpcoesController;

/**
 *
 * @author Rafael
 */
public class TelaServico_1_Opcoes extends javax.swing.JFrame {

    private final TelaServico_1_OpcoesController controller;
    
    /**
     * Creates new form TelaPrincipal
     */
    public TelaServico_1_Opcoes() {
        initComponents();
        controller = new TelaServico_1_OpcoesController(this);
    }
    ...
    private void initComponents() {
        ...
        jLabelMensagem1.setText("Serviços");
        getContentPane().add(jLabelMensagem1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 150, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaServico_1_Opcoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaServico_1_Opcoes().setVisible(true);
            }
        });
    }
