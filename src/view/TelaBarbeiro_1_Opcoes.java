...
public class TelaBarbeiro_1_Opcoes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonCadastrar.setText("Alterar ou Excluir Barbeiro");
        getContentPane().add(jButtonCadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 370, 400, 40));

        jButtonAlterarExcluir.setText("Cadastrar Novo Barbeiro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBarbeiro_1_Opcoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBarbeiro_1_Opcoes().setVisible(true);
            }
        });
    }
